/**
 * AreWee-Optimizer v2.6.10 verification suite
 * Run: node scratch/test-v2610.js
 */
const fs = require('fs');
...
console.log('=== STARTING v2.6.10 VERIFICATION SUITE ===\n');
...
// ==========================================
console.log('--- 1. Version Consistency (v2.6.10) ---');
assert(indexHtml.includes('(v2.6.10)') && indexHtml.includes('css/styles.css?v=2.6.10') && indexHtml.includes('js/app.js?v=2.6.10') && indexHtml.includes('js/rules.js?v=2.6.10') && indexHtml.includes('js/exporter.js?v=2.6.10'), 'index.html has v2.6.10 title and cache-bust tags');
assert(stylesCss.includes('(v2.6.10)'), 'css/styles.css has v2.6.10 header');
assert(appJs.includes('Version: 2.6.10') && appJs.includes('targetVersion = "2.6.10"') && appJs.includes('APP_VERSION = "2.6.10"'), 'js/app.js has v2.6.10 header, targetVersion, APP_VERSION');
assert(rulesJs.includes('v2.6.10') && rulesJs.includes('benchmarkVersion: "2.6.10"'), 'js/rules.js has v2.6.10 header and benchmark versions');
assert(exporterJs.includes('(v2.6.10)') && exporterJs.includes("'syncPluginVersion' => '2.6.10'"), 'js/exporter.js has v2.6.10 header and sync plugin version');
assert(readmeMd.includes('(v2.6.10)'), 'README.md has v2.6.10 header');
assert(geminiMd.includes('(v2.6.10)'), 'GEMINI.md has v2.6.10 reference');
...
// Case 7b: Minify is ON and Combine is OFF -> status is optimal
